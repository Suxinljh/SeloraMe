...
const scale: Scale = {
  ...
  intro: [
    ...
    '共 20 题，每题在“符合 / 不符合”中选择，分为动机过弱、动机过强、学习兴趣、学习目标四个分量表。',
  ],
  highlights: '20 题｜4 个分量表｜困扰筛查',
  benefits: [
  ...
  scoring: {
    kind: 'profile',
    profileNote:
      '本表为多维剖析型，4 个分量表各 5 题。任一分量表得分 ≥3 分，即认为相应方面' +
      '存在学习欲望上的困扰或认识偏差。报告页应分别呈现四个分量表结果。',
  },
}
