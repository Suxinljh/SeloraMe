...
const scale: Scale = {
  ...
  price: '¥5.9',
  intro: [
    '《青少年时间管理倾向评测》（ATMD）由黄希庭、张志杰等人编制，用于评估青少年的时间管理倾向。',
    '共 44 题，分时间价值感、时间监控观、时间效能感三个分评测，采用五级计分。',
  ],
  highlights: '44 题｜3 分评测 9 子维度｜五级计分',
  benefits: [
  ...
  scoring: {
    kind: 'profile',
    profileNote:
      '本表为多维剖析型，不做总分。三个分评测（时间价值感 10 题、时间监控观 24 题、' +
